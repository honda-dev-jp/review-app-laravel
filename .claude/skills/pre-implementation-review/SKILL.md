...
- PHP 8.4.24 / Laravel 12.66.0（PHPはIssue #130の作業ブランチ上で確認した更新後baseline候補。PR未作成、`develop`・`main`・本番環境へ未反映。Laravel 12.66.0はPR #127で`develop`へマージ済み） / Laravel Sail / MySQLを前提とします。
